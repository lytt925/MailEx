...
export function LoginForm() {
    return (
        <div className="md:w-6/12 lg:ml-6 lg:w-4/12">
            <form>
                {/* Email input */}
